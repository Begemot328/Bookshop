...
<html>
<head>
    <title><fmt:message key="add.shop.title"/></title>
    <style>
        body {
            display: block;
...
<div class="w3-cell-row">
    ...
    <div class="w3-cell w3-padding-large w3-center" style="width:70%">
        ...
        <form class="w3-card-4 w3-row-padding" method="POST"
              action="${pageContext.request.contextPath}/ControllerURL" enctype="multipart/form-data">
            <input type="hidden" name="command" value="ADD_SHOP_COMMAND">
            <div class="w3-container" style="width:35%">
                <input class="w3-input w3-border" type="text" name="shopName" required value="${shopName}"
                       placeholder="<fmt:message key="shop.name"/>">
            </div>
            <div class="w3-container" style="width:35%">
                <input class="w3-input w3-border" type="text" name="address" required value="${address}"
